...
last letter is smaller (first in alphabet) than first letter is reversed. Then all buckets are sorted using radix sort. All
same words now are next to each other. They are counted in linear way in buckets.
"""
